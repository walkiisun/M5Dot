...
void loop() {
  if(finishCollection == true){
    ...
    sendMQTT(createOutMQTT(officalStart, officalEnd, rowData.accXArray, macAddress, unitArray[0]));
    delay(delayTime);

    sendMQTT(createOutMQTT(officalStart, officalEnd, rowData.accYArray, macAddress, unitArray[1]));
    delay(delayTime);
